...
//硬件产品配置
var hardware_prod=[
    {pid:2,name:"晓译翻译机-智能硬件",android:"http://mall.xunfei.cn/wap/goods/index/35285",ios:"http://mall.xunfei.cn/wap/goods/index/35285",wechat:"http://mall.xunfei.cn/wap/goods/index/35285"},
    // {pid:3,name:"阿尔法小蛋",android:"https://detail.tmall.com/item.htm?spm=a220z.1000880.0.0.ZIbQmF&id=538801879981",ios:"https://detail.tmall.com/item.htm?spm=a220z.1000880.0.0.ZIbQmF&id=538801879981",wechat:"http://mall.xunfei.cn/wap/goods/index/35215"},
    // {pid:3,name:"阿尔法小蛋",android:"http://zmnxbc.com/s/Ei8mg?tm=1e6aa2",ios:"https://detail.tmall.com/item.htm?spm=a220z.1000880.0.0.ZIbQmF&id=538801879981",wechat:"http://mall.xunfei.cn/wap/goods/index/35215"},
    {pid:3,name:"阿尔法小蛋-智能硬件",android:"http://e22a.com/h.rtEmFe",ios:"http://e22a.com/h.rtEmFe",wechat:"http://mall.xunfei.cn/wap/goods/index/35215"},
    {pid:4,name:"阿尔法大蛋-智能硬件",android:"http://mall.xunfei.cn/wap/goods/index/35264",ios:"http://mall.xunfei.cn/wap/goods/index/35264",wechat:"http://mall.xunfei.cn/wap/goods/index/35264"},
    {pid:5,name:"智能台灯-智能硬件",android:"http://mall.xunfei.cn/wap/goods/index/35292",ios:"http://mall.xunfei.cn/wap/goods/index/35292",wechat:"http://mall.xunfei.cn/wap/goods/index/35292"},
    {pid:6,name:"小飞鱼-智能硬件",android:"http://mall.xunfei.cn/wap/goods/index/35290",ios:"http://mall.xunfei.cn/wap/goods/index/35290",wechat:"http://mall.xunfei.cn/wap/goods/index/35290"},
    {pid:7,name:"叮咚音箱-智能硬件",android:"http://mall.xunfei.cn/wap/goods/index/35900",ios:"http://mall.xunfei.cn/wap/goods/index/35900",wechat:"http://mall.xunfei.cn/wap/goods/index/35900"},
];
//软件产品 下载配置
...
function init() {
    ...
    eventUtil.addHandler(document.getElementById("drop-down"),'click',function (e) {
        ...
        if(name=='hardware'){
            //百度统计
            _hmt.push(['_trackEvent','用户行为', 'click',"硬件商城", 1]);
            //讯飞统计
            _wa("event","send","用户行为","click","硬件商城",1);
            //友盟统计
            _czc.push(['_trackEvent','用户行为', 'click',"硬件商城", 1]);
            
            var urlToGo = 'http://mall.xunfei.cn';
            var w=window.open(urlToGo);
            if(!w || !w.window){
                window.location.href=urlToGo;
            }
    ...
    eventUtil.addHandler(document.getElementById("more-hardware"),'click',function (e) {
        var urlToGo = 'http://mall.xunfei.cn';
        var w=window.open(urlToGo);
        if(!w || !w.window){
            window.location.href=urlToGo;
